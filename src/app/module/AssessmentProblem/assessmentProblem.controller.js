...
const createAssessmentProblem = catchAsync(async (req, res) => {
    ...
    const result = await AssessmentProblemService.createAssessmentProblem(userId, userRole, id, req.body);
    sendResponse(res, {
...
const updateAssessmentProblem = catchAsync(async (req, res) => {
    ...
    const result = await AssessmentProblemService.updateAssessmentProblem(userId, userRole, id, req.body);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
