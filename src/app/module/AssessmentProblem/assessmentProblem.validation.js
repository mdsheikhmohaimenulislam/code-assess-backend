...
export const updateAssessmentProblemValidationSchema = z
	.object({
		marks: z.number().positive("Marks must be greater than 0").optional(),
		order: z.number().int().positive("Order must be greater than 0").optional(),
	})
	.refine((data) => data.marks !== undefined || data.order !== undefined, {
		message: "At least one field is required",
	});
//# sourceMappingURL=assessmentProblem.validation.js.map
