import { AttemptStatus, ProblemType, ProgrammingLanguage } from "../../../generated/prisma/enums.js";
import { prisma } from "../../lib/prisma.js";
import { AppError } from "../../utils/AppError.js";
import httpStatus from 'http-status';
const createAnswer = async (userId, attemptId, problemId, answer, language) => {
    // --------------------------------
    ...
    if (problem.type !== ProblemType.CODING) {
        throw new AppError(httpStatus.BAD_REQUEST, "This endpoint is only for coding problems");
    }
    // --------------------------------
