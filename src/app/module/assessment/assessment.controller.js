...
const createAssessment = catchAsync(async (req, res) => {
    ...
    const result = await AssessmentService.createAssessment(userId, userRole, req.body);
    sendResponse(res, {
...
const updateAssessment = catchAsync(async (req, res) => {
    ...
    const result = await AssessmentService.updateAssessment(userId, userRole, id, req.body);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
...
const updateAssessmentStatus = catchAsync(async (req, res) => {
    ...
    const result = await AssessmentService.updateAssessmentStatus(userId, userRole, id, status);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
