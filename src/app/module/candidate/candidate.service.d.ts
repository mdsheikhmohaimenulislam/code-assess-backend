...
declare const createCandidate: (userId: string, payload: CreateCandidatePayload) => Promise<{
    user: {
        email: string;
        id: string;
        name: string;
...
declare const updateCandidate: (userId: string, candidateId: string, payload: UpdateCandidatePayload) => Promise<{
    user: {
        email: string;
        id: string;
        name: string;
...
declare const deleteCandidate: (userId: string, candidateId: string) => Promise<{
    id: string;
    deleted: boolean;
}>;
