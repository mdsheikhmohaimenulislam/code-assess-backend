...
const createCandidate = async (userId, payload) => {
    // Check user
    ...
    if (user.role !== Role.CANDIDATE) {
        throw new AppError(httpStatus.FORBIDDEN, "Only candidate can create candidate profile");
    }
...
const getMyCandidate = async (userId) => {
...
const updateCandidate = async (userId, candidateId, payload) => {
    /**
    ...
    if (candidate.userId !== userId) {
        throw new AppError(httpStatus.FORBIDDEN, "You are not allowed to update this profile");
    }
    /**
...
const deleteCandidate = async (userId, candidateId) => {
    /**
     * Find candidate profile
     */
    const candidate = await prisma.candidateProfile.findUnique({
     ...
     */
    if (candidate.userId !== userId) {
        throw new AppError(httpStatus.FORBIDDEN, "You are not allowed to delete this profile");
    }
    /**
