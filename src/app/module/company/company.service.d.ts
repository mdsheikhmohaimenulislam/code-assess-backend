...
declare const createCompany: (currentUserId: string, currentUserRole: Role, payload: CreateCompanyPayload) => Promise<{
    companyName: string;
    createdAt: Date;
...
declare const updateCompany: (userId: string, userRole: Role, companyId: string, payload: UpdateCompanyPayload) => Promise<{
    companyName: string;
    createdAt: Date;
    description: string | null;
    id: string;
...
declare const deleteCompany: (userId: string, userRole: Role, companyId: string) => Promise<{
    companyName: string;
    id: string;
}>;
