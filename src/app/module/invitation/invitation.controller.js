...
const createInvitation = catchAsync(async (req, res) => {
    ...
    const result = await InvitationService.createInvitation(userId, userRole, req.body);
    sendResponse(res, {
...
const getInvitations = catchAsync(async (req, res) => {
    ...
    const result = await InvitationService.getInvitations(userId, userRole, req.query);
    sendResponse(res, {
...
const getInvitationById = catchAsync(async (req, res) => {
    ...
    const result = await InvitationService.getInvitationById(userId, userRole, invitationId);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
