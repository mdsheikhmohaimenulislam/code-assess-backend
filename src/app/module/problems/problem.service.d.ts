...
import type { ICreateProblemPayload, IGetProblemsQuery, IUpdateProblemPayload } from "./problem.interface.js";
declare const createProblem: (userId: string, payload: ICreateProblemPayload) => Promise<({
    mcqOptions: {
        id: string;
        problemId: string;
        text: string;
...
declare const updateProblem: (userId: string, userRole: Role, problemId: string, payload: IUpdateProblemPayload) => Promise<{
    category: string;
    constraints: string | null;
    createdAt: Date;
    createdById: string;
...
declare const deleteProblem: (userId: string, userRole: Role, problemId: string) => Promise<void>;
