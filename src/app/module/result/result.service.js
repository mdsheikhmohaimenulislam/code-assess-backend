...
// Create Result
// ============================================
const createResult = async (attemptId, userId, userRole) => {
    // ============================================
    ...
    if (userRole === Role.COMPANY &&
        ...
        throw new AppError(httpStatus.FORBIDDEN, "You are not allowed to create this result");
    }
    // ============================================
    // 5. Attempt must be submitted
    // ============================================
    if (attempt.status !== AttemptStatus.SUBMITTED) {
        throw new AppError(httpStatus.BAD_REQUEST, "Attempt must be submitted before creating result");
    }
    // ============================================
    ...
    const percentage = totalMarks > 0
        ? Number(((obtainedMarks / totalMarks) *
            100).toFixed(2))
        : 0;
    // ============================================
    // 12. Check Pass / Fail
    // ============================================
    const passed = obtainedMarks >=
