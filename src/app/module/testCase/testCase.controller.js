...
const createTestCase = catchAsync(async (req, res) => {
    ...
    const result = await TestCaseService.createTestCase(userId, userRole, id, req.body);
    sendResponse(res, {
...
const getTestCases = catchAsync(async (req, res) => {
    ...
    const result = await TestCaseService.getTestCase(userId, userRole, id);
    sendResponse(res, {
...
const updateTestCase = catchAsync(async (req, res) => {
    ...
    const result = await TestCaseService.updateTestCase(userId, userRole, id, req.body);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
...
const deleteTestCase = catchAsync(async (req, res) => {
    ...
    await TestCaseService.deleteTestCase(userId, userRole, id);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
