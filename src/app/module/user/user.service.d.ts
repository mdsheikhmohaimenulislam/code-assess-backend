...
declare const updateMyProfile: (userId: string, payload: IUpdatedProfile) => Promise<{
    authProvider: import("../../../generated/prisma/enums.js").AuthProvider;
    createdAt: Date;
    email: string;
    emailVerified: boolean;
...
declare const updateUserStatus: (userId: string, payload: IUserUpdatedProfile) => Promise<{
    authProvider: import("../../../generated/prisma/enums.js").AuthProvider;
    createdAt: Date;
    email: string;
    emailVerified: boolean;
